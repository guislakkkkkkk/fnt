function onCreate()
	-- background shit
	makeLuaSprite('torrentBack0','backgroundpixel3',-220,-120)
	...
	makeLuaSprite('torrentBack1','backgroundpixel4',-35000,-120)
	...
	makeLuaSprite('torrentBack2','backgroundpixel5',-35000,-120)
