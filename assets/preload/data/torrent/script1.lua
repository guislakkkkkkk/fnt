...
function onTimerCompleted(tag, loops, loopsLeft)
	...
	if tag == 'whoaPrecountdownanim' then
		...
		dialstage = 1
		playSound('voiceActing/song1_0', 1)

		makeLuaText('DiaLine1', '', 0, 230, 490)
		Line1 = 'Greetings, my shortstacked blue'
		textProgress = 0
...
function nextLine(number)
	...
	if number == 2 then
		...
		Line2typed = ''
		playSound('voiceActing/song1_1', 1)
	end

	if number == 3 then
		setProperty('bfPortrait1.alpha', 0)
		setProperty('torrentPortrait1.alpha', 1)
		Line1 = 'I am currently in the process of'
		textProgress = 0
		Line1typed = ''
		Line1finished = false
		Line2 = 'acquiring all your confidential'
		setTextString('DiaLine2', '')
		Line2typed = ''
		L2Progress = 0
		Line2finished = false
		...
		Line3typed = ''
		L3Progress = 0
		playSound('voiceActing/song1_2', 1)
	end

	if number == 4 then
		Line1 = 'But while we wait...'
		textProgress = 0
		Line1typed = ''
		Line1finished = false
		Line2 = ''
		...
		Line3typed = ''
		L3Progress = 0
		playSound('voiceActing/song1_3', 1)
	end

	if number == 5 then
		Line1 = "Let's have some fun shall we?"
		textProgress = 0
		Line1typed = ''
		Line1finished = false
		Line2 = ''
		...
		Line3typed = ''
		L3Progress = 0
		playSound('voiceActing/song1_4', 1)
	end
